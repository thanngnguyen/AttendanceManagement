        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassLatitude = table.Column<double>(type: "float", nullable: true),
                    ClassLongitude = table.Column<double>(type: "float", nullable: true),
                    AllowedDistanceMeters = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SlotLatitude = table.Column<double>(type: "float", nullable: true),
                    SlotLongitude = table.Column<double>(type: "float", nullable: true),
                    AllowedDistanceMeters = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceSlots", x => x.SlotId);
                    table.ForeignKey(
                        name: "FK_AttendanceSlots_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignmentId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SubmissionText = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    AttachmentUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistanceFromClass = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_AttendanceSlots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_AttendanceSlots_SlotId",
                        column: x => x.SlotId,
                        principalTable: "AttendanceSlots",
                        principalColumn: "SlotId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceFlags", x => x.FlagId);
                    table.ForeignKey(
                        name: "FK_AttendanceFlags_AttendanceRecords_RecordId",
                        column: x => x.RecordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceFlags_RecordId",
                table: "AttendanceFlags",
                column: "RecordId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_SlotId_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSlots_ClassId",
                table: "AttendanceSlots",
                column: "ClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_SlotId_StudentId",
                table: "LeaveRequests",
                columns: new[] { "SlotId", "StudentId" });
